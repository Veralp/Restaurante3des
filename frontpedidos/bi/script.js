...
const listarTodos = () => {
    ...
    produtos.forEach((p, i) => {
        ...
        pedido.innerHTML = `
                    ...
                    <td data-label="Entrega:">${p.dataEntrega != null ? p.dataEntrega.toString().slice(0, 10) : p.dataCozinha != null ?'':''} ${p.dataEntrega != null ? p.dataEntrega.toString().slice(11, 16) : ''}</td>
